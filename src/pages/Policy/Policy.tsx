...
const Policy = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Privacy Policy | Elite Arrival</title>
        <meta
          property="og:title"
          content="Privacy Policy | Elite Arrival"
        ></meta>
        <meta
      ...
      <div className="screen">
        ...
        <div className="content mt64">
          ...
          <p className="paragraph text-center mt32">
            ...
            Car Services, we're committed to protecting and respecting the
            privacy of our valued clients and visitors. This Privacy & Policy
            page outlines how we manage, store, and use the personal information
            you share with us.
          </p>
          ...
          <p className="paragraph text-center mt16">
            When you interact with the "Elite Arrival" section or make use of
          ...
          <p className="paragraph text-center mt16">
            Elite Car Services reserves the right to update this privacy policy
