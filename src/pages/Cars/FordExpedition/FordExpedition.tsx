  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Ford Expedition | Luxury Car Rental with Driver in Chicago
        </title>
        <meta
          property="og:title"
          content="Ford Expedition | Luxury Car Rental with Driver in Chicago"
        ></meta>
        <meta
          property="og:description"
          content="Experience ruggedness and luxury with the Ford Expedition. Choose the Ford Expedition for your next journey in Chicago and enjoy comfort and versatility"
        ></meta>
        <meta
          name="description"
          content="Experience ruggedness and luxury with the Ford Expedition. Choose the Ford Expedition for your next journey in Chicago and enjoy comfort and versatility"
          ...
          <div className="text-content">
            ...
            <div className="text-content mt32">
              ...
              <p className="paragraph mt32 w40">
                ...
                and refinement. With its spacious cabin, advanced technology,
                and impressive towing capacity, this vehicle is perfect for
                family trips or outdoor adventures in style.
              </p>
            </div>
